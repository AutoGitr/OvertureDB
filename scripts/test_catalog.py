...
class ContractTests(unittest.TestCase):
    def test_complete_repository_satisfies_contract(self) -> None:
        self.assertTrue(catalog.dataset())

    def test_entries_have_typed_identifiers_and_bounded_metadata(self) -> None:
    ...
    def test_valid_themerrdb_youtube_id(self) -> None:
        entry = movie(youtube_id_themerrdb="3U6PSWyv5sc")
        self.assertEqual(validate_entry(entry), entry)

    def test_youtube_ids_must_be_different(self) -> None:
        entry = movie(
            youtube_id_overturedb="3U6PSWyv5sc",
            youtube_id_themerrdb="3U6PSWyv5sc",
        )
    ...
    def test_identity_uniqueness_is_scoped_to_media_type(self) -> None:
        self.assertEqual(
...
class BuildTests(unittest.TestCase):
    ...
    def test_publication_is_reproducible_and_digests_match(self) -> None:
        self.build("first")
        self.build("second")
    ...
    def test_invalid_entry_prevents_any_publication(self) -> None:
    ...
    def test_filename_and_directory_follow_entry_identity(self) -> None:
    ...
    def test_same_numeric_movie_and_show_id_have_separate_files(self) -> None:
    ...
    def test_cli_validate_entry_does_not_load_dataset(
    ...
    def test_cli_validate_entry_rejects_invalid_path(self) -> None:
    ...
    def test_cli_validate_entry_checks_filename_and_directory(self) -> None:
        for destination in ("data/movies/tmdb-2.json", "data/shows/tmdb-1.json"):
            target = self.root / destination
            self.entry.rename(target)
            with (
    ...
    def test_cli_validate_entry_rejects_invalid_content(self) -> None:
    ...
    def test_cli_validates_multiple_entries_and_checks_each_url_once(
        self, art: MagicMock
    ) -> None:
...
class ArtworkTests(unittest.TestCase):
    ...
    @patch.object(catalog, "check_art_destination")
    @patch.object(catalog, "build_opener")
    def test_image_probe_retries_on_http_429(
